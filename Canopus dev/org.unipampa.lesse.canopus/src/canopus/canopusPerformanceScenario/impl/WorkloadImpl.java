 ...
 * </p>
 * <ul>
 *   <li>{@link canopus.canopusPerformanceScenario.impl.WorkloadImpl#getWorkload <em>Workload</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkloadImpl extends MinimalEObjectImpl.Container implements Workload {
	 ...
	 * @ordered
	 */
	protected EList<WorkloadModel> workload;
	 ...
	 * @generated
	 */
	public EList<WorkloadModel> getWorkload() {
		if (workload == null) {
			workload = new EObjectContainmentEList<WorkloadModel>(WorkloadModel.class, this, CanopusPerformanceScenarioPackage.WORKLOAD__WORKLOAD);
		}
		return workload;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case CanopusPerformanceScenarioPackage.WORKLOAD__WORKLOAD:
				getWorkload().clear();
				getWorkload().addAll((Collection<? extends WorkloadModel>)newValue);
				return;
		}
