 ...
 * @generated
 */
public class OpenmlperfPerformanceMetricSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public OpenmlperfPerformanceMetricSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OpenmlperfPerformanceMetricPackage.MEMORY: {
			...
			case OpenmlperfPerformanceMetricPackage.DISK: {
			...
			case OpenmlperfPerformanceMetricPackage.ASSOCIATION_COUNTER_CRITERIA_THRESHOLD: {
			...
			case OpenmlperfPerformanceMetricPackage.COUNTER: {
				Counter counter = (Counter)theEObject;
				T result = caseCounter(counter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenmlperfPerformanceMetricPackage.DISK_IO_COUNTER: {
			...
			case OpenmlperfPerformanceMetricPackage.CRITERIA: {
				Criteria criteria = (Criteria)theEObject;
				T result = caseCriteria(criteria);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenmlperfPerformanceMetricPackage.THRESHOLD: {
				Threshold threshold = (Threshold)theEObject;
				T result = caseThreshold(threshold);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenmlperfPerformanceMetricPackage.MEMORY_COUNTER: {
			...
			case OpenmlperfPerformanceMetricPackage.TRANSACTION: {
			...
			case OpenmlperfPerformanceMetricPackage.TRANSACTION_COUNTER: {
			...
			case OpenmlperfPerformanceMetricPackage.METRIC: {
...
} //OpenmlperfPerformanceMetricSwitch
