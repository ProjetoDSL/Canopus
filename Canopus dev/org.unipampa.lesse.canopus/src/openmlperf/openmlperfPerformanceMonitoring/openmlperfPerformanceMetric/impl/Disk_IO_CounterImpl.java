...
import openmlperf.openmlperfPerformanceMonitoring.openmlperfPerformanceMetric.COUNTER_DISK;
 ...
 * </p>
 * <ul>
 *   <li>{@link openmlperf.openmlperfPerformanceMonitoring.openmlperfPerformanceMetric.impl.Disk_IO_CounterImpl#getCounterDisk <em>Counter Disk</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Disk_IO_CounterImpl extends CounterImpl implements Disk_IO_Counter {
	...
	protected EClass eStaticClass() {
		return OpenmlperfPerformanceMetricPackage.Literals.DISK_IO_COUNTER;
	}
	...
	public void setCounterDisk(COUNTER_DISK newCounterDisk) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceMetricPackage.DISK_IO_COUNTER__COUNTER_DISK, oldCounterDisk, counterDisk));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpenmlperfPerformanceMetricPackage.DISK_IO_COUNTER__COUNTER_DISK:
