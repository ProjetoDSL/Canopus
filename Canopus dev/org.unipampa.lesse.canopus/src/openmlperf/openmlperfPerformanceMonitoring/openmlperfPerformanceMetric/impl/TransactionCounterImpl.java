...
import openmlperf.openmlperfPerformanceMonitoring.openmlperfPerformanceMetric.COUNTER_TRANSACTION;
 ...
 * </p>
 * <ul>
 *   <li>{@link openmlperf.openmlperfPerformanceMonitoring.openmlperfPerformanceMetric.impl.TransactionCounterImpl#getCounterTransaction <em>Counter Transaction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransactionCounterImpl extends CounterImpl implements TransactionCounter {
	...
	protected EClass eStaticClass() {
		return OpenmlperfPerformanceMetricPackage.Literals.TRANSACTION_COUNTER;
	}
	...
	public void setCounterTransaction(COUNTER_TRANSACTION newCounterTransaction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceMetricPackage.TRANSACTION_COUNTER__COUNTER_TRANSACTION, oldCounterTransaction, counterTransaction));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpenmlperfPerformanceMetricPackage.TRANSACTION_COUNTER__COUNTER_TRANSACTION:
