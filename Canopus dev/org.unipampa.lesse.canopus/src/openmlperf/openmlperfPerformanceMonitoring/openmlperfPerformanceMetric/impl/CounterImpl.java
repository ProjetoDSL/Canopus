 ...
 * </p>
 * <ul>
 *   <li>{@link openmlperf.openmlperfPerformanceMonitoring.openmlperfPerformanceMetric.impl.CounterImpl#getName <em>Name</em>}</li>
 *   <li>{@link openmlperf.openmlperfPerformanceMonitoring.openmlperfPerformanceMetric.impl.CounterImpl#getAssociationcountercriteriathreshold <em>Associationcountercriteriathreshold</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class CounterImpl extends MinimalEObjectImpl.Container implements Counter {
	...
	protected EClass eStaticClass() {
		return OpenmlperfPerformanceMetricPackage.Literals.COUNTER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceMetricPackage.COUNTER__NAME, oldName, name));
	}
	...
	public EList<AssociationCounterCriteriaThreshold> getAssociationcountercriteriathreshold() {
		if (associationcountercriteriathreshold == null) {
			associationcountercriteriathreshold = new EObjectResolvingEList<AssociationCounterCriteriaThreshold>(AssociationCounterCriteriaThreshold.class, this, OpenmlperfPerformanceMetricPackage.COUNTER__ASSOCIATIONCOUNTERCRITERIATHRESHOLD);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpenmlperfPerformanceMetricPackage.COUNTER__NAME:
				return getName();
			case OpenmlperfPerformanceMetricPackage.COUNTER__ASSOCIATIONCOUNTERCRITERIATHRESHOLD:
