 ...
 * </p>
 * <ul>
 *   <li>{@link openmlperf.openmlperfPerformanceMonitoring.openmlperfPerformanceMetric.impl.CriteriaImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CriteriaImpl extends MinimalEObjectImpl.Container implements Criteria {
	...
	protected EClass eStaticClass() {
		return OpenmlperfPerformanceMetricPackage.Literals.CRITERIA;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceMetricPackage.CRITERIA__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpenmlperfPerformanceMetricPackage.CRITERIA__VALUE:
				return getValue();
		}
