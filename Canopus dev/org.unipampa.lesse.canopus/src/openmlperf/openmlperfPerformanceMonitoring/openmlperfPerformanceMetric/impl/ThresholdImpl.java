 ...
 * </p>
 * <ul>
 *   <li>{@link openmlperf.openmlperfPerformanceMonitoring.openmlperfPerformanceMetric.impl.ThresholdImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThresholdImpl extends MinimalEObjectImpl.Container implements Threshold {
	...
	protected EClass eStaticClass() {
		return OpenmlperfPerformanceMetricPackage.Literals.THRESHOLD;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceMetricPackage.THRESHOLD__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpenmlperfPerformanceMetricPackage.THRESHOLD__VALUE:
				return getValue();
		}
