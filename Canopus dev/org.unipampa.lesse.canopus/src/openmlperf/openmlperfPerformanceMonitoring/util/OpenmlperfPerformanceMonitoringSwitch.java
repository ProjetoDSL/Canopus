 ...
 * @generated
 */
public class OpenmlperfPerformanceMonitoringSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public OpenmlperfPerformanceMonitoringSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OpenmlperfPerformanceMonitoringPackage.SUT: {
				SUT sut = (SUT)theEObject;
				T result = caseSUT(sut);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenmlperfPerformanceMonitoringPackage.LOAD_GENERATOR: {
				LoadGenerator loadGenerator = (LoadGenerator)theEObject;
				T result = caseLoadGenerator(loadGenerator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenmlperfPerformanceMonitoringPackage.MONITOR: {
				Monitor monitor = (Monitor)theEObject;
				T result = caseMonitor(monitor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenmlperfPerformanceMonitoringPackage.METRIC_MODEL: {
...
} //OpenmlperfPerformanceMonitoringSwitch
