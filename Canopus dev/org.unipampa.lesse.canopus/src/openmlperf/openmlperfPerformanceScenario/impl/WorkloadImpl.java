 ...
 * </p>
 * <ul>
 *   <li>{@link openmlperf.openmlperfPerformanceScenario.impl.WorkloadImpl#getRampUpTimer <em>Ramp Up Timer</em>}</li>
 *   <li>{@link openmlperf.openmlperfPerformanceScenario.impl.WorkloadImpl#getRampDownUsers <em>Ramp Down Users</em>}</li>
 *   <li>{@link openmlperf.openmlperfPerformanceScenario.impl.WorkloadImpl#getRampUpUsers <em>Ramp Up Users</em>}</li>
 *   <li>{@link openmlperf.openmlperfPerformanceScenario.impl.WorkloadImpl#getRampDownTimer <em>Ramp Down Timer</em>}</li>
 *   <li>{@link openmlperf.openmlperfPerformanceScenario.impl.WorkloadImpl#getName <em>Name</em>}</li>
 *   <li>{@link openmlperf.openmlperfPerformanceScenario.impl.WorkloadImpl#getTime <em>Time</em>}</li>
 *   <li>{@link openmlperf.openmlperfPerformanceScenario.impl.WorkloadImpl#getVirtualUsers <em>Virtual Users</em>}</li>
 *   <li>{@link openmlperf.openmlperfPerformanceScenario.impl.WorkloadImpl#getTimeType <em>Time Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkloadImpl extends MinimalEObjectImpl.Container implements Workload {
	...
	protected EClass eStaticClass() {
		return OpenmlperfPerformanceScenarioPackage.Literals.WORKLOAD;
	}
	...
	public NotificationChain basicSetRampUpTimer(RampUpTimer newRampUpTimer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_UP_TIMER, oldRampUpTimer, newRampUpTimer);
	...
	public void setRampUpTimer(RampUpTimer newRampUpTimer) {
		if (newRampUpTimer != rampUpTimer) {
			...
			if (rampUpTimer != null)
				msgs = ((InternalEObject)rampUpTimer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_UP_TIMER, null, msgs);
			if (newRampUpTimer != null)
				msgs = ((InternalEObject)newRampUpTimer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_UP_TIMER, null, msgs);
			msgs = basicSetRampUpTimer(newRampUpTimer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_UP_TIMER, newRampUpTimer, newRampUpTimer));
	}
	...
	public NotificationChain basicSetRampDownUsers(RampDownUsers newRampDownUsers, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_DOWN_USERS, oldRampDownUsers, newRampDownUsers);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRampDownUsers(RampDownUsers newRampDownUsers) {
		if (newRampDownUsers != rampDownUsers) {
			...
			if (rampDownUsers != null)
				msgs = ((InternalEObject)rampDownUsers).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_DOWN_USERS, null, msgs);
			if (newRampDownUsers != null)
				msgs = ((InternalEObject)newRampDownUsers).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_DOWN_USERS, null, msgs);
			msgs = basicSetRampDownUsers(newRampDownUsers, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_DOWN_USERS, newRampDownUsers, newRampDownUsers));
	}
	...
	public NotificationChain basicSetRampUpUsers(RampUpUsers newRampUpUsers, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_UP_USERS, oldRampUpUsers, newRampUpUsers);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRampUpUsers(RampUpUsers newRampUpUsers) {
		if (newRampUpUsers != rampUpUsers) {
			NotificationChain msgs = null;
			if (rampUpUsers != null)
				msgs = ((InternalEObject)rampUpUsers).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_UP_USERS, null, msgs);
			if (newRampUpUsers != null)
				msgs = ((InternalEObject)newRampUpUsers).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_UP_USERS, null, msgs);
			msgs = basicSetRampUpUsers(newRampUpUsers, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_UP_USERS, newRampUpUsers, newRampUpUsers));
	}
	...
	public NotificationChain basicSetRampDownTimer(RampDownTimer newRampDownTimer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_DOWN_TIMER, oldRampDownTimer, newRampDownTimer);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRampDownTimer(RampDownTimer newRampDownTimer) {
		if (newRampDownTimer != rampDownTimer) {
			...
			if (rampDownTimer != null)
				msgs = ((InternalEObject)rampDownTimer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_DOWN_TIMER, null, msgs);
			if (newRampDownTimer != null)
				msgs = ((InternalEObject)newRampDownTimer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_DOWN_TIMER, null, msgs);
			msgs = basicSetRampDownTimer(newRampDownTimer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceScenarioPackage.WORKLOAD__RAMP_DOWN_TIMER, newRampDownTimer, newRampDownTimer));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceScenarioPackage.WORKLOAD__NAME, oldName, name));
	}
	...
	public void setTime(int newTime) {
		...
		time = newTime;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceScenarioPackage.WORKLOAD__TIME, oldTime, time));
	}
	...
	public void setVirtualUsers(int newVirtualUsers) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceScenarioPackage.WORKLOAD__VIRTUAL_USERS, oldVirtualUsers, virtualUsers));
	}
	...
	public void setTimeType(TimeType newTimeType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceScenarioPackage.WORKLOAD__TIME_TYPE, oldTimeType, timeType));
	}
