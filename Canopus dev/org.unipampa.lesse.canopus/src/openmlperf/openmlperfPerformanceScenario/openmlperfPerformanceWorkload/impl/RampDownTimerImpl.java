 ...
 * </p>
 * <ul>
 *   <li>{@link openmlperf.openmlperfPerformanceScenario.openmlperfPerformanceWorkload.impl.RampDownTimerImpl#getTime <em>Time</em>}</li>
 *   <li>{@link openmlperf.openmlperfPerformanceScenario.openmlperfPerformanceWorkload.impl.RampDownTimerImpl#getTimeType <em>Time Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RampDownTimerImpl extends MinimalEObjectImpl.Container implements RampDownTimer {
	...
	protected EClass eStaticClass() {
		return OpenmlperfPerformanceWorkloadPackage.Literals.RAMP_DOWN_TIMER;
	}
	...
	public void setTime(int newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceWorkloadPackage.RAMP_DOWN_TIMER__TIME, oldTime, time));
	}
	...
	public void setTimeType(TimeTypeRamps newTimeType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceWorkloadPackage.RAMP_DOWN_TIMER__TIME_TYPE, oldTimeType, timeType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpenmlperfPerformanceWorkloadPackage.RAMP_DOWN_TIMER__TIME:
				return getTime();
			case OpenmlperfPerformanceWorkloadPackage.RAMP_DOWN_TIMER__TIME_TYPE:
				return getTimeType();
		}
