 ...
 * </p>
 * <ul>
 *   <li>{@link openmlperf.openmlperfPerformanceScenario.openmlperfPerformanceWorkload.impl.RampUpUsersImpl#getVirtualUsers <em>Virtual Users</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RampUpUsersImpl extends MinimalEObjectImpl.Container implements RampUpUsers {
	...
	protected EClass eStaticClass() {
		return OpenmlperfPerformanceWorkloadPackage.Literals.RAMP_UP_USERS;
	}
	...
	public void setVirtualUsers(int newVirtualUsers) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenmlperfPerformanceWorkloadPackage.RAMP_UP_USERS__VIRTUAL_USERS, oldVirtualUsers, virtualUsers));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpenmlperfPerformanceWorkloadPackage.RAMP_UP_USERS__VIRTUAL_USERS:
