 ...
 * @generated
 */
public class OpenmlperfPerformanceScriptingSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public OpenmlperfPerformanceScriptingSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OpenmlperfPerformanceScriptingPackage.INITIAL: {
				Initial initial = (Initial)theEObject;
				T result = caseInitial(initial);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenmlperfPerformanceScriptingPackage.FINAL: {
				Final final_ = (Final)theEObject;
				T result = caseFinal(final_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenmlperfPerformanceScriptingPackage.ACTIVITY: {
				Activity activity = (Activity)theEObject;
				T result = caseActivity(activity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenmlperfPerformanceScriptingPackage.THINK_TIME: {
				ThinkTime thinkTime = (ThinkTime)theEObject;
				T result = caseThinkTime(thinkTime);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenmlperfPerformanceScriptingPackage.SAVE_PARAMETERS: {
				SaveParameters saveParameters = (SaveParameters)theEObject;
				T result = caseSaveParameters(saveParameters);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenmlperfPerformanceScriptingPackage.DATA_TABLE: {
				DataTable dataTable = (DataTable)theEObject;
				T result = caseDataTable(dataTable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenmlperfPerformanceScriptingPackage.PARAMETER_OBJECT: {
				ParameterObject parameterObject = (ParameterObject)theEObject;
				T result = caseParameterObject(parameterObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenmlperfPerformanceScriptingPackage.COLUMNS_OBJECT: {
				ColumnsObject columnsObject = (ColumnsObject)theEObject;
				T result = caseColumnsObject(columnsObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenmlperfPerformanceScriptingPackage.ACTIVITY_TO_ACTIVITY: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Columns Object</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Columns Object</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseColumnsObject(ColumnsObject object) {
		return null;
	}
...
} //OpenmlperfPerformanceScriptingSwitch
