...
/**
 * This is the item provider adapter for a {@link openmlperf.openmlperfPerformanceScenario.openmlperfPerformanceWorkload.RampDownTimer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OpenmlperfPerformanceWorkloadPackage.Literals.RAMP_DOWN_TIMER__TIME,
				 true,
				 false,
				 false,
	...
	protected void addTimeTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RampDownTimer_timeType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RampDownTimer_timeType_feature", "_UI_RampDownTimer_type"),
				 OpenmlperfPerformanceWorkloadPackage.Literals.RAMP_DOWN_TIMER__TIME_TYPE,
				 true,
				 false,
				 false,
