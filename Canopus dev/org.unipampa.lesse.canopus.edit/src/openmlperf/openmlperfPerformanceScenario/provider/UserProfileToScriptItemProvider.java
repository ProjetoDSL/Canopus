...
/**
 * This is the item provider adapter for a {@link openmlperf.openmlperfPerformanceScenario.UserProfileToScript} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OpenmlperfPerformanceScenarioPackage.Literals.USER_PROFILE_TO_SCRIPT__TIME_PERCENTAGE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OpenmlperfPerformanceScenarioPackage.Literals.USER_PROFILE_TO_SCRIPT__USERPROFILE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OpenmlperfPerformanceScenarioPackage.Literals.USER_PROFILE_TO_SCRIPT__SCRIPTING,
				 true,
				 false,
				 true,
				 null,
