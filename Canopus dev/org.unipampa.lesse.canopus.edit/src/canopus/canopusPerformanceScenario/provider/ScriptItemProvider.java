...
/**
 * This is the item provider adapter for a {@link canopus.canopusPerformanceScenario.Script} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScriptItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addScriptingmodelPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Scriptingmodel feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addScriptingmodelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Script_scriptingmodel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Script_scriptingmodel_feature", "_UI_Script_type"),
				 CanopusPerformanceScenarioPackage.Literals.SCRIPT__SCRIPTINGMODEL,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CanopusPerformanceScenarioPackage.Literals.SCRIPT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Script_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Script_description_feature", "_UI_Script_type"),
				 CanopusPerformanceScenarioPackage.Literals.SCRIPT__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
