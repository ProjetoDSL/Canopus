...
/**
 * This is the item provider adapter for a {@link canopus.canopusPerformanceScenario.canopusPerformanceWorkload.VirtualUsers} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VirtualUsersItemProvider 
	 ...
	 * @generated
	 */
	public VirtualUsersItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VirtualUsers_virtualUsers_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VirtualUsers_virtualUsers_feature", "_UI_VirtualUsers_type"),
				 CanopusPerformanceWorkloadPackage.Literals.VIRTUAL_USERS__VIRTUAL_USERS,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VirtualUsers"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VirtualUsers.class)) {
